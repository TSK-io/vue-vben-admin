...
from app.api.v1.endpoints import admin, auth, bindings, chats, community, docs, elder, family, health, notifications, phone_directory, risk_alerts, risk_recognition
...
api_router.include_router(phone_directory.router, tags=["Phone Directory"])
